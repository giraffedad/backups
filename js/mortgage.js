...
if (!inheritCity) {
    window.location.href = "mortgage.html?province=" + remote_ip_info.province + "&city=" + remote_ip_info.city;
}
//地区弹框on/off
! function() {
...
$(".citys").unbind('click').on("click", ".cityItem", function() {
    ...
    //重定向刷新当前页面   ######mark
    window.location.href = "mortgage.html?province=" + areaData[provinceSet].name + "&city=" + areaData[provinceSet].city[index].name;
